...
export default function ProjectData() {
  return (
    <div className="h-screen w-5/6 md:w-full py-28">
      <h1 className="willow-font text-xl md:text-3xl text-yellow-600 text-center pb-8">
        [my_work].cont
      </h1>
      <div className="grid grid-cols-1 gap-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 place-self-center">
          ...
          <AllProjects
            id="meals"
            img={require("../images/foodPic.png")}
            repo="https://github.com/wlowrimore/react_food_app"
            live="https://delishmeals.vercel.app/"
          />
          <AllProjects
            id="code"
      ...
      <div className="view-link mt-10">
        <li className="view-resume-style pb-10">

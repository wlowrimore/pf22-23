    ...
    <div className='h-screen'>
      <div className='w-full my-12'>
        <div className='text-center w-full'>
          ...
          <p className='text-gray-200 text-xl tracking-wider'>C'mon what are you waiting for? Get in touch!</p>
        </div>
      </div>
      ...
      <form method='POST' action='https://getform.io/f/6abdad5b-4a46-407f-bb7c-c5c283ad82b7' className='max-w-[800px] w-100 mx-4 bg-gray-800 p-8 mb-12 rounded-md shadow-md shadow-gray-700 flex flex-col justify-center items-center'>
        <h2 className='text-center text-gray-200 text-xl tracking-wider mb-4'>Leave a message here, or contact me via the links below.</h2>
      ...
      <div className='grid grid-cols-11 place-items-center h-[50px] w-100'>
        ...
        <div className='grid col-span-3'>
          <a href='https://linkedin.com/in/william-lowrimore-21778310' 
            target='_blank' 
            className='text-gray-400 hover:text-purple-300 hover:cursor-pointer text-3xl mr-6'
            onMouseOver={handleMouseOver} 
            onMouseOut={handleMouseOut}>
            <FaLinkedinIn />
        ...
        <div className='grid col-span-3'>
          <a href='https://williamlowrimore.com' 
            target='_blank' 
            className='text-gray-400 hover:text-purple-300 hover:cursor-pointer text-3xl mr-12' 
            onMouseOver={handleMouseOver} 
            onMouseOut={handleMouseOut}>
            <FaGlobe />
